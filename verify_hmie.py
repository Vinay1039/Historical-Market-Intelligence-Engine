...
def run_build_verification():
    ...
    # Check Static Dashboard UI Files
    static_file = r'c:\Users\vinay\.gemini\Fyers_Hist\public\index.html'
    if os.path.exists(static_file):
        print(f"{'Stage 7: Visual Research Dashboard UI':<42} | {'FASTAPI STATIC (/explorer)':<28} | {'Chart.js SPA':>14} | PASS [DASHBOARD READY]")
        passed += 1
    else:
        print(f"{'Stage 7: Visual Research Dashboard UI':<42} | {'FASTAPI STATIC (/explorer)':<28} | {'MISSING':>14} | FAIL")
        failed += 1
