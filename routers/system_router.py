...
===============================================================================
 ...
 Exposes:
   ...
   - GET /api/v1/events/{event_id}: Returns structured payload for event landing page with:
       • Master Liquid F&O Champions (15) & Underperformed Laggards (15)
...
def get_event_details(event_id: str):
    ...
    try:
        ...
        # Top Liquid High-Volume F&O Champions (15 Stocks: NIFTY50(4), BANK NIFTY(4), NIFTY MIDCAP(4), NIFTY AUTO(3))
        fo_stocks = [
            # NIFTY50 Champions (4)
            ...
            {"rank": 2, "name": "Reliance Industries", "symbol": "RELIANCE", "universe": "NIFTY50", "avg_return": "+2.80%", "pre_return": "+1.55%", "post_return": "+1.25%", "win_rate": "73.3%", "std_dev": "1.65%", "best_year": "+4.90% (2021)", "worst_year": "-1.05% (2019)"},
            {"rank": 3, "name": "Bharti Airtel", "symbol": "BHARTIARTL", "universe": "NIFTY50", "avg_return": "+2.50%", "pre_return": "+1.40%", "post_return": "+1.10%", "win_rate": "66.7%", "std_dev": "1.55%", "best_year": "+4.35% (2023)", "worst_year": "-0.80% (2019)"},
            {"rank": 4, "name": "Hindalco Industries", "symbol": "HINDALCO", "universe": "NIFTY50", "avg_return": "+2.10%", "pre_return": "+1.15%", "post_return": "+0.95%", "win_rate": "60.0%", "std_dev": "2.45%", "best_year": "+5.10% (2021)", "worst_year": "-0.90% (2019)"},

            # BANK NIFTY Champions (4)
            {"rank": 5, "name": "ICICI Bank", "symbol": "ICICIBANK", "universe": "BANK NIFTY", "avg_return": "+3.95%", "pre_return": "+2.15%", "post_return": "+1.80%", "win_rate": "86.7%", "std_dev": "2.10%", "best_year": "+8.45% (2020)", "worst_year": "-1.10% (2019)"},
            {"rank": 6, "name": "Axis Bank", "symbol": "AXISBANK", "universe": "BANK NIFTY", "avg_return": "+3.40%", "pre_return": "+1.90%", "post_return": "+1.50%", "win_rate": "73.3%", "std_dev": "2.15%", "best_year": "+6.90% (2022)", "worst_year": "-1.60% (2019)"},
            {"rank": 7, "name": "State Bank of India", "symbol": "SBIN", "universe": "BANK NIFTY", "avg_return": "+2.75%", "pre_return": "+1.50%", "post_return": "+1.25%", "win_rate": "66.7%", "std_dev": "2.20%", "best_year": "+5.20% (2022)", "worst_year": "-1.50% (2019)"},
            {"rank": 8, "name": "Punjab National Bank", "symbol": "PNB", "universe": "BANK NIFTY", "avg_return": "+2.45%", "pre_return": "+1.35%", "post_return": "+1.10%", "win_rate": "66.7%", "std_dev": "2.80%", "best_year": "+5.80% (2022)", "worst_year": "-1.85% (2019)"},

            # NIFTY MIDCAP Champions (4)
            {"rank": 9, "name": "Polycab India", "symbol": "POLYCAB", "universe": "NIFTY MIDCAP", "avg_return": "+3.65%", "pre_return": "+2.05%", "post_return": "+1.60%", "win_rate": "75.0%", "std_dev": "2.30%", "best_year": "+6.90% (2021)", "worst_year": "-1.05% (2022)"},
            {"rank": 10, "name": "Dixon Technologies", "symbol": "DIXON", "universe": "NIFTY MIDCAP", "avg_return": "+2.88%", "pre_return": "+1.60%", "post_return": "+1.28%", "win_rate": "73.3%", "std_dev": "2.60%", "best_year": "+6.20% (2023)", "worst_year": "-1.30% (2019)"},
            ...
            {"rank": 12, "name": "Persistent Systems", "symbol": "PERSISTENT", "universe": "NIFTY MIDCAP", "avg_return": "+2.40%", "pre_return": "+1.30%", "post_return": "+1.10%", "win_rate": "66.7%", "std_dev": "2.10%", "best_year": "+4.95% (2023)", "worst_year": "-1.10% (2019)"},

            # NIFTY AUTO Champions (3)
            {"rank": 13, "name": "Tata Motors", "symbol": "TATAMOTORS", "universe": "NIFTY AUTO", "avg_return": "+4.15%", "pre_return": "+2.35%", "post_return": "+1.80%", "win_rate": "86.7%", "std_dev": "2.40%", "best_year": "+8.45% (2020)", "worst_year": "-1.40% (2019)"},
            {"rank": 14, "name": "Mahindra & Mahindra", "symbol": "M&M", "universe": "NIFTY AUTO", "avg_return": "+3.45%", "pre_return": "+1.95%", "post_return": "+1.50%", "win_rate": "80.0%", "std_dev": "1.75%", "best_year": "+5.10% (2024)", "worst_year": "-1.15% (2019)"},
        ...
        # Liquid High-Volume F&O Underperforming Laggards (15 Stocks: NIFTY50(4), BANK NIFTY(4), NIFTY MIDCAP(4), NIFTY AUTO(3))
        laggard_stocks = [
            # NIFTY50 Laggards (4)
            ...
            {"rank": 9, "name": "L&T Finance", "symbol": "LTF", "universe": "NIFTY MIDCAP", "avg_return": "-1.25%", "pre_return": "-0.70%", "post_return": "-0.55%", "win_rate": "33.3%", "std_dev": "2.85%", "best_year": "+1.40% (2021)", "worst_year": "-4.80% (2018)"},
            {"rank": 10, "name": "Apollo Tyres", "symbol": "APOLLOTYRE", "universe": "NIFTY MIDCAP", "avg_return": "-1.15%", "pre_return": "-0.65%", "post_return": "-0.50%", "win_rate": "33.3%", "std_dev": "2.60%", "best_year": "+1.30% (2020)", "worst_year": "-4.30% (2019)"},
            {"rank": 11, "name": "Exide Industries", "symbol": "EXIDEIND", "universe": "NIFTY MIDCAP", "avg_return": "-0.90%", "pre_return": "-0.50%", "post_return": "-0.40%", "win_rate": "40.0%", "std_dev": "2.30%", "best_year": "+1.15% (2022)", "worst_year": "-3.80% (2018)"},
            {"rank": 12, "name": "Voltas Ltd", "symbol": "VOLTAS", "universe": "NIFTY MIDCAP", "avg_return": "-0.80%", "pre_return": "-0.45%", "post_return": "-0.35%", "win_rate": "40.0%", "std_dev": "2.15%", "best_year": "+1.10% (2021)", "worst_year": "-3.50% (2019)"},
